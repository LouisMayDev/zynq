...
HD_PWD='D:/WorkSpace/Vivado/ps_emio_clg400/ps_emio_clg400.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_emio_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_emio_wrapper.tcl
