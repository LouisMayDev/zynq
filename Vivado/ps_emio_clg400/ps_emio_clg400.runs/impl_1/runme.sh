...
HD_PWD='D:/WorkSpace/Vivado/ps_emio_clg400/ps_emio_clg400.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_emio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ps_emio_wrapper.tcl -notrace
