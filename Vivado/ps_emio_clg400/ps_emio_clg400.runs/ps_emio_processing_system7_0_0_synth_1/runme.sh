...
HD_PWD='D:/WorkSpace/Vivado/ps_emio_clg400/ps_emio_clg400.runs/ps_emio_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_emio_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_emio_processing_system7_0_0.tcl
